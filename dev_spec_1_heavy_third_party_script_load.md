...
Site: domesticdomestic.com · Priority 1 · High · Effort: Medium (2-5 days)

## Problem
The homepage loads 56 scripts, which is the usual root cause of slow interaction readiness on mobile.

## Evidence (from the live site)
> Measured on the live homepage: 41 inline and 15 external <script> tags, 300 KB of HTML.

## Current state
notes: 56 scripts, 300 KB HTML
